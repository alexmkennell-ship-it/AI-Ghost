// bob.js — Expressive Build 3.1 “Cinematic Focus” (fixed braces)
// • 5.8 m base camera orbit, 7.2 m sleep pan-out
// • Auto-focus tracks head every 1 s
// • All Living Bob 2.9 features intact

const WORKER_URL = "https://ghostaiv1.alexmkennell.workers.dev";
const MODEL_BASE = "https://pub-30bcc0b2a7044074a19efdef19f69857.r2.dev/models/";

// ---------------------------------------------------------------------------
// Keep your ANIM definitions, utility functions, warmup(), setAnim(), etc.
// ---------------------------------------------------------------------------

// ---------- Camera (cinematic distance) ----------
...
function startFocusTracking() {
  ...
  const tick = () => {
    ...
    try {
      ...
      console.warn("Focus tracking error:", err);
    }
    focusRAF = requestAnimationFrame(tick);
  };
  focusRAF = requestAnimationFrame(tick);
